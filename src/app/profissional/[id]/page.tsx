...
const ALIASES_INSTITUICOES: Record<string, string> = {
  ...
  "usp-sp": "Universidade de São Paulo (USP)",
  "usp/bauru": "Universidade de São Paulo (USP Bauru)",
  "usp-bauru": "Universidade de São Paulo (USP Bauru)",
  "usp/unifesp": "Universidade de São Paulo (USP) / Universidade Federal de São Paulo (UNIFESP)",
  ...
  "hjm": "Hospital Juliano Moreira (HJM)",
};
